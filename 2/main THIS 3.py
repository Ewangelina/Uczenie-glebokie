...
class LetterDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        encoded_target = med.encode(self.data[idx+1:idx+self.seq_length+1])
        return torch.tensor(sequence, dtype=torch.long), torch.tensor(encoded_target, dtype=torch.long)
        ...
        for num_layers in nl_tab: # Number of LSTM layers
            ...
            for epoch in range(num_epochs):
                ...
                for sequences, targets in data_loader:
                    ...
                    loss.backward()
                    optimizer.step()
                    model_name = ".\\saved_models\\" + current_model_description + "temp_model.sav"
